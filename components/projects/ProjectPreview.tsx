...
return ( <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#07070c] shadow-2xl shadow-black/30">
{/* Cinematic ambient background */} <div className="pointer-events-none absolute inset-0 overflow-hidden">
<div
...
```
  ...
  <div className="relative z-10 p-4 sm:p-6">
    <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-black/30">
      <div className="relative aspect-[16/9] w-full overflow-hidden bg-[#0b0b12]">
        ...
        <div className="absolute left-4 top-4">
          ...
          >
            Project / {String(activeImage + 1).padStart(2, "0")}
          </span>
        </div>
