...
const INTRO_STORAGE_KEY = "faiza-portfolio-intro-seen";
...
useEffect(() => {
// ---------------------------------------------------------
// Run intro ONLY once per browser tab.
// sessionStorage survives refresh and same-tab navigation,
// but a new tab gets its own sessionStorage.
// ---------------------------------------------------------
...
// Mark it immediately so refresh/navigation during the intro
// cannot trigger the animation again.
